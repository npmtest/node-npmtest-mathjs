...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mathjs/node_modules/mathjs/lib/expression/node/FunctionNode.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mathjs/node_modules/mathjs/lib/expression/node/FunctionNode.js</span></h1>
    <h2>
        
        Statements: <span class="metric">20.12% <small>(33 / 164)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">20.25% <small>(33 / 163)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mathjs/node_modules/mathjs/lib/expression/node/</a> &#187; FunctionNode.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   * @private
   */
<span class="fstat-no" title="function not covered" >  function compileFunctionNode(node, defs, args) {</span>
    // compile fn and arguments
<span class="cstat-no" title="statement not covered" >    var jsFn = compile(node.fn, defs, args);</span>
...
<span class="cstat-no" title="statement not covered" >    var jsScope = compileScope(defs, args);</span>
<span class="cstat-no" title="statement not covered" >    var argsName;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (node.fn.isSymbolNode) {</span>
      // we can statically determine whether the function has an rawArgs property
<span class="cstat-no" title="statement not covered" >      var name = node.fn.name;</span>
...
<span class="cstat-no" title="statement not covered" >        argsName = node._getUniqueArgumentsName(defs);</span>
<span class="cstat-no" title="statement not covered" >        defs[argsName] = node.args;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return jsFn + '(' + jsArgs.join(', ') + ')';</span>
    ...
    else <span class="cstat-no" title="statement not covered" >if (node.fn.isAccessorNode &amp;&amp; node.fn.index.isObjectProperty()) {</span>
      // execute the function with the right context: the object of the AccessorNode
<span class="cstat-no" title="statement not covered" >      argsName = node._getUniqueArgumentsName(defs);</span>
<span class="cstat-no" title="statement not covered" >      defs[argsName] = node.args;</span>
<span class="cstat-no" title="statement not covered" >      defs.validateSafeMethod = validateSafeMethod</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var jsObject = compile(node.fn.object, defs, args);</span>
<span class="cstat-no" title="statement not covered" >      var jsProp = stringify(node.fn.index.getObjectProperty());</span>
&nbsp;
...
&nbsp;
   ...
   * @private
   */
<span class="fstat-no" title="function not covered" >  function compileScope (defs, args) {</span>
...
<span class="cstat-no" title="statement not covered" >            return stringify(arg) + ': ' + arg;</span>
          })
          .join(', ');
&nbsp;
...
&nbsp;
   ...
   * @private
   */
  FunctionNode.prototype._getUniqueArgumentsName = <span class="fstat-no" title="function not covered" >function (defs) {</span>
<span class="cstat-no" title="statement not covered" >    var argsName;</span>
...
&nbsp;
   ...
   */
  FunctionNode.prototype.forEach = <span class="fstat-no" title="function not covered" >function (callback) {</span>
...
&nbsp;
   ...
   */
  FunctionNode.prototype.map = <span class="fstat-no" title="function not covered" >function (callback) {</span>
...
&nbsp;
   ...
   * @return {FunctionNode}
   */
  FunctionNode.prototype.clone = <span class="fstat-no" title="function not covered" >function () {</span>
...
&nbsp;
   ...
   * @override
   */
  FunctionNode.prototype.toString = <span class="fstat-no" title="function not covered" >function (options) {</span>
...
&nbsp;
   ...
   * @return {string} str
   */
  FunctionNode.prototype._toString = <span class="fstat-no" title="function not covered" >function (options) {</span>
...
&nbsp;
   ...
   * @return {string}
   */
  FunctionNode.prototype.toTex = <span class="fstat-no" title="function not covered" >function (options) {</span>
...
&nbsp;
   ...
   * @return {string} str
   */
  FunctionNode.prototype._toTex = <span class="fstat-no" title="function not covered" >function (options) {</span>
...
&nbsp;
   ...
   * @return {string}
   */
  FunctionNode.prototype.getIdentifier = <span class="fstat-no" title="function not covered" >function () {</span>
